...
\end{figure}
    ...
    To solve this problem different approach can be followed:
     ...
     \begin{itemize}
        ...
        \newpage
        \subsection{Implied value calculation} \label{subsection:3.1.1}
        ...
        \subsection{Impact on Curve and Repricing Errors} \label{subsection:3.1.2}
    ...
    As already discussed in previous chapters, the key point in a state-of-the-art curve bootstrapping is to obtain smooth forward rates.
    ...
    To perform the analysis for the EUR market case the same dataset has been used while for the USD case another dataset, dated on {\it 5-October-2016}, has been used which is shown in the following figure.
    ...
    As the EUR market case, to avoid over-fitting problems, the USD overnight curve calibration has been performed using only a wide subset of the instruments listed above which is summarized in the next figure.
    ...
    \end{figure}
       ...
       \begin{enumerate}
        ...
        \subsection{The USD market case: Negative Jumps} \label{subsection:3.3.2}
...
\section{Conclusion}\label{section:3.4}  
