...
To perform all the analysis a market dataset dating at {\it 29-January-2016} will be used, which is shown in the following figure. 

\begin{figure}[!h]
\centering
\includegraphics[width=0.9\textwidth]{images/dataset.png}
\caption{Market dataset used to perform the analysis.}
\label{fig:dataset}
\end{figure}
...
\end{figure}
    ...
    In order to do that, for even the best interpolation scheme to be effective, any market jump must be removed before the curve calibration and than added back at the end of the process.
       ...
       \begin{enumerate}
        ...
        \newpage
        The next to Figures shows the impact of first jump inclusion in the curves shape. 
        
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.8\textwidth]{images/firstjumpeur1.png}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.8\textwidth]{images/firstjumpeur2.png}
        ...
        Applying the same procedure but using the reviewed formula it is now possible to make an estimation of the USD jumps and account them in the USD overnight curve as the next two figure show.
        
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.8\textwidth]{images/firstjumpusd1.png}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.8\textwidth]{images/firstjumpusd2.png}
        ...
        To analyze the impact of the first jump inclusion the Figure \ref{fig:repricingjump} shows how some out-of-curve instruments with short, medium and long tenor are re-priced including or not the first jump. 
        
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.50\textwidth]{images/repricingjump.png}
        \caption{Re-pricing errors in Bps between different tenors OIS market quotes and the same instruments derived from the USD overnight curve calibrated.}
        \label{fig:repricingjump}
        \end{figure}
        As expected, the strongest impact is on the short term section in which market OIS are re-priced much better meanwhile, on longer tenors, the benefits are less considerable.
