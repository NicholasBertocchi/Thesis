...
To perform the analysis it will be used a market dataset dating at {\it 29-January-2016} which is shown in the following figure. 
...
\end{figure}
    ...
    In order to do that, it will be used a market dataset dating at {\it 29-January-2016} which is shown in the following figure.
     ...
     \begin{itemize}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.55\textwidth]{images/exclude.png}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.55\textwidth]{images/excluded2.png}
        \label{fig:excluded2}
        \end{figure}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.68\textwidth]{images/excludingcurve.png}
        ...
        \begin{figure}[!h]
        \centering
        \includegraphics[width=0.68\textwidth]{images/includingcurve.png}
    ...
    \section{Mixed Interpolation technique}\label{section:3.2}
